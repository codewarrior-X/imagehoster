...
public class CommentController {
    ...
    //The method also receives tags parameter which is a string of all the tags separated by a comma using the annotation @RequestParam,@PathVariabl
    @RequestMapping(value = "/image/{imageId}/{imageTitle}/comments", method = RequestMethod.POST)
    public String CommentSubmit(@PathVariable("imageId") Integer ImageId, @PathVariable("imageTitle") String imageTitle, @RequestParam("comment") String text, Comment comment, HttpSession session){
